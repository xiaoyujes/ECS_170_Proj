...
class Method_MLP(method, nn.Module):
    ...
    def forward(self, x):
        ...
        y_pred = self.activation_func_5(self.fc_layer_5(h4))  # raw logits for 10 classes
        return y_pred
        # output layer result
        ...
        for epoch in range(self.max_epoch): # you can do an early stop if self.max_epoch is too much...
            ...
            if epoch % 10 == 0:
                ...
                print('Macro - Precision:', metrics['precision_macro'],
                      ...
                      'F1:', metrics['f1_macro'])
                print('Micro - Precision:', metrics['precision_micro'],
    ...
    def run(self):
        ...
        return {'pred_y': pred_y, 'true_y': self.data['test']['y'],'history': self.history}
