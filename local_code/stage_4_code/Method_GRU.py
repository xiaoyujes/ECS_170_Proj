...
class Method_GRU(method, nn.Module):
    ...
    embedding_dim = 128 #size of the dense vector each token is mapped to before entering GRU
    hidden_size = 256 #number of features in GRU hidden state
    ...
    def __init__(self, mName, mDescription, vocab_size, sequence_length):
        ...
        self.gru = nn.GRU(
            ...
            dropout=0.3 #dropout between layers only
        )
