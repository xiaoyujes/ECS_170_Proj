...
from local_code.stage_4_code.text_generation.Jeslyn.Method_RNN import Method_RNN
...
if 1:
    ...
    result_obj.result_destination_file_name = 'generated_RNN_'
