...
from local_code.stage_3_code.Jeslyn.Method_ResNet_ORL import Method_ResNet_ORL
...
if 1:
    ...
    method_obj = Method_ResNet_ORL('ResNet for ORL', '')
    method_obj.data = {
    ...
    print(f'ResNet Accuracy: {metrics * 100:.2f}%')
    print('\nOther Metrics: ')
