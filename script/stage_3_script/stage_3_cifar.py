...
# ---------------- LOAD DATA ----------------
data_obj = Dataset_Loader_CIFAR()
data_obj.data_root = '../../data/stage_3_data/CIFAR'
...
saver.result_destination_file_name   = 'cifar_predictions'
...
fig.suptitle('CIFAR-10 CNN - Learning Curves', fontsize=14)
...
plt.tight_layout()
plt.savefig('../../result/stage_3_result/learning_curve_cifar.png', dpi=150)
plt.show()
