...
# ---------------- LOAD DATA ----------------
data_obj = Dataset_Loader_ORL()
data_obj.data_root = '../../data/stage_3_data/ORL'
...
saver.result_destination_file_name   = 'orl_predictions'
...
fig.suptitle('ORL CNN - Learning Curves', fontsize=14)
...
plt.tight_layout()
plt.savefig('../../result/stage_3_result/learning_curve_orl.png', dpi=150)
plt.show()
